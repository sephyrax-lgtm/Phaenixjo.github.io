...
const certifications = [
  ...
  { id: 5, nom: "PIX", organisme: "PIX", date: "2023", file: "/Note_PIX.pdf" },           // PDF
  { id: 6, nom: "Certification ANSSI", organisme: "ANSSI", date: "2024", file: "/images/cert7.png" }, 
  { id: 7, nom: "Atelier RGPD", organisme: "CNIL", date: "2025", file: "/images/cert6.png" },       // PDF
      ...
      >
        {certifications.map((cert) => (
          <motion.div
            ...
            whileTap={{ scale: 0.97 }}
            className="bg-white/5 border border-green-400/40 backdrop-blur-lg p-6 rounded-3xl shadow-lg hover:shadow-green-500/50 transition-all duration-300 cursor-pointer relative overflow-hidden"
            onClick={() => window.open(cert.file, "_blank")} // ouvre PDF ou image
          >
