  ...
  return (
    <div className="space-y-12 px-4 md:px-0">
      ...
      <motion.h2
        ...
        className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-teal-300 drop-shadow-lg text-center"
      >
        ✨ À propos du BTS SIO
      </motion.h2>
      ...
      <motion.div
        ...
        className="backdrop-blur-md bg-white/5 border border-cyan-500/20 p-6 rounded-2xl shadow-lg"
      >
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-[#2b2b2b] to-[#1a1a1a] p-6 rounded-2xl border-l-4 border-pink-500 shadow-lg backdrop-blur-sm"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          <div>
            ...
            <h4 className="text-2xl font-bold text-pink-400 mb-6">Débouchés professionnels</h4>
      ...
      <motion.div
        ...
        whileHover={{ scale: 1.04 }}
        className="bg-gradient-to-br from-[#0f2027] via-[#203a43] to-[#2c5364] p-6 rounded-2xl border-l-4 border-green-400 shadow-lg backdrop-blur-sm"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          <div>
            ...
            <h4 className="text-2xl font-bold text-green-300 mb-6">Débouchés professionnels</h4>
            <ul className="space-y-2">
              {[
      ...
      <motion.div
        ...
        className="mt-6 overflow-x-auto backdrop-blur-md bg-white/5 border border-cyan-500/20 p-6 rounded-2xl shadow-lg"
      >
        <table className="w-full text-left border-collapse">
          ...
          <tbody>
            {[
              ...
              ["E6 SISR", "Administration des systèmes et des réseaux", "pink-400"],
              ["E6 SLAM", "Conception et développement d'applications", "emerald-400"],
              ...
              >
                <td className={`py-2 px-4 font-medium ${color ? `text-${color}` : 'text-cyan-400'}`}>{ep}</td>
